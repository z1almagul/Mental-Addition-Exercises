...
function start(min, max){
    ...
    let sum = getRandomIntInclusive(min,max);
    let random = getRandomIntInclusive(min,sum);
...
function setCharLimit(){
    let answer = Number.parseInt(document.getElementById('result').textContent) - Number.parseInt(document.getElementById('randomNumber').textContent);
    let digit = 1;
